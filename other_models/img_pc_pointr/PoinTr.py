...
class PoinTr(nn.Module):
    ...
    def forward(self, imgs_feat, pc):
        q, coarse_point_cloud = self.base_model(imgs_feat, pc) # B M C and B M 3
        ...
        rebuild_points_1 = torch.cat([rebuild_points_0, fps(pc, self.num_pred - M * self.fold_step**2)],dim=1).contiguous()
        ret = (querries_all, rebuild_points_0, rebuild_points_1)
